...
** Metrics
   ...
   allows the user to similtaneously score object detection on
   ...
   #+begin_src shell
     synet metrics DATA1.YAML DATA2.YAML... --out-dirs OUT_DIR1 OUT_DIR2... --project PLOT_DIR  --precisions PRECISON...
   #+end_src
